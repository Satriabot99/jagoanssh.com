...
$stats_password="kampret"; //password to login to stats.php. Change this!!!
...
// Mysql settings
$MySql_username="jagoanss_speedtest";
$MySql_password="?UM3Bk)Go[pu";
$MySql_hostname="localhost";
$MySql_databasename="jagoanss_speedtest";
$MySql_port="3306";
