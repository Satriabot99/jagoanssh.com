...
<h1>Paket Data XL</h1></center>
    <div class="form-group">No TELP: (gunakan awalan 62877xx)
    <input type="number" class="form-control" name="msisdn" value="<?=$nomor;?>" placeholder="628782xx" required></div>
    <div class="form-group">OTP:        
    <input type="text" class="form-control" name="passwd" value="<?=$otp;?>"></div> 
    <div align="center">
    <button class="btn btn-primary" input type="submit" id="login" name="login">Login</button></p>
    <button class="btn btn-success" input type="submit" id="otp" name="reqOTP">Minta OTP</button>
