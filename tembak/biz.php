...
<div class="container">
<div class="row">
<div class="col-md-3 col-lg-6" data-wow-duration="1s">
<div class="box">
<h1>Paket BIZ Starter</h1>
<div class="table-responsive-md">
<table class="table table-hover">
<tbody>
<tr>
<th>Kuota utama</th>
<td>5GB di semua jaringan</td>
</tr>
<tr>
<th>Kuota IG & FB</th>
<td>1GB di semua jaringan</td>
</tr>
<tr>
<th>Unlimited Nelpon dan SMS</th>
<td>Ke semua XL & AXIS</td>
</tr>
<tr>
<th>Operator Lain</th>
<td>30 Menit + 30 SMS</td>
</tr>
<tr>
...
<td>Rp 49.000</td>
    ...
    <div class="col-md-3 col-lg-6" data-wow-duration="1s">
    <div class="probootstrap-form probootstrap-box">
    <form method="post">
    <center>
<div class="icon"><i class="icon-checkbox-checked"></i></div>
<h1>Tembak Paket BIZ</h1></center>
    <form method="post">
        <div class="form-group">
			<label>Pilih Paket</label>
			<select class="form-control" name="reg">
			<option <?php if ($anuID == 1 ) echo 'selected' ; ?> value="1">BIZ STARTER 5GB & (Unlimited Line,WA, BBM), 30hr, Rp49.000</option>
			</select>
		</div>
		<div align="center">
		<button class="btn btn-info btn-block" input type="button" onclick="window.location = 'clear.php';"> Keluar</button>
        <button class="btn btn-warning btn-block" input type="button" onclick="window.location = 'index.php';"> Kembali</button>
        <button class="btn btn-primary btn-block" input type="submit">Beli Paket</button>
        <p>
<?php
