...
<div class="alert alert-danger text-center"><i class="icon-new"></i> Untuk Menghindari Penyalahgunaan Website Ini Melakukan Buka - Tutup, Silahkan Cek Secara Berkala.</div>
...
<input class="form-control" type="number" name="msisdn"<?php if (isset($_SESSION['msisdn'])) {echo ' value="' . $_SESSION['msisdn'] . '"';}?> placeholder="628xx"></div>
<div class="form-group">Kode OTP
<input class="form-control" type="number" name="otp"></div>
<!---<div class="form-group">Key
<input class="form-control" type="password" name="key" <?php if (isset($_POST['key'])) {echo 'value="' . $_POST['key'] . '"';}?>></div>--->
<div align="center">
<button class="btn btn-success" type="submit" name="login">Login</button></p>
<button class="btn btn-info btn-block" type="submit" name="clear">Clear Session</button>
<button class="btn btn-primary btn-block" type="submit" name="submit-otp">Kirim OTP</button></p>
</form>
<?php
if (isset($_SESSION['hasill'])) {
    echo '<center><div class="alert alert-danger">' . $_SESSION['hasill'] . ' <p>Gagal Login, Silahkan Clear Session Jika Selalu Gagal.</div></center>';
}
?>
<?php
include('ads/ads.php');
