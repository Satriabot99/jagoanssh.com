...
else if (isset($_POST['submit-otp']))
{
    $msisdn = $_POST['msisdn'];

    $_SESSION['msisdn'] = $msisdn;
    $_SESSION['send'] = otp($msisdn);
    // include "view.php";
}
...
else if (isset($_POST['tembak']))
{
    ...
    switch($id)
    {
        case "0x1": $finalid = "00009040"; break; //1 GB 3 DAY
        case "0x2": $finalid = "00007333"; break; //2 GB 3 DAY
        case "0x3": $finalid = "00023847"; break; //3 GB 3 DAY
