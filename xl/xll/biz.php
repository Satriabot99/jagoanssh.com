...
<!DOCTYPE html>
    ...
    <title>Paket Data XL BIZ - Jagoanssh</title>
...
<h1>Pilih Paket Data</h1></center>
    <form method="post">
		...
		<div align="center">
        <p><button class="btn btn-danger" input type="button" onclick="window.location = 'index.php';" style="glyphicon glyphicon-circle-arrow-left"> Kembali</button></p>
