...
<head>
    ...
    <title>Tembak Paket Axis - Jagoanssh.com</title>
    <meta name="description" content="Jagoanssh - Tembak Paket Telkomsel"/>
...
<section id="services" class="probootstrap-section">
    ...
    <p class="text-center">
    <span class="badge badge-success mb-3 p-3">Tembak Paket Axis</span>
    <span class="badge badge-info mb-3 p-3">Tembak Paket XL</span>
    <span class="badge badge-warning mb-3 p-3">Tembak Paket Telkomsel</span>
    <span class="badge badge-primary mb-3 p-3">Tembak Paket Indosat</span>
    <span class="badge badge-success mb-3 p-3">Tembak Paket Three</span>
    <span class="badge badge-primary mb-3 p-3">Tembak Kuota Murah</span>
    <span class="badge badge-info mb-3 p-3">Tembak Paket Internet</span>
  </div>
  </div>
</section>
<?php
...
<section class="probootstrap-section">
    <div class="container">
    <div class="alert alert-info text-center"><i class="icon-new"></i> Free Kuota Game 1GB 7 hari</div>
    <div class="row">
    <div class="col-md-6 col-md-offset-3">
<form class="probootstrap-form probootstrap-box validate-form" method="post">
<center><h1>TEMBAK AXIS</h1></center>
...
<!---<button class="btn btn-primary btn-block" type="submit" name="changestyle">Menu Tembak Masa Aktif</button>--->
<button class="btn btn-success btn-block" type="submit" name="submit-auth">Beli Sekarang</button>
<br>
<?php
include "module.php";
   ...
   /// $json = json_decode($hasil, TRUE);
	...
	//if ($index == "2") {
        	//	echo "<center><div class=".$success.">Terima kasih sudah berkunjung ke JAGOANSSH<p>Transaksi anda sedang di proses.</div></center>";
               // }
                // else{
            	//	echo "<center><div class=".$warning.">Paket tidak dapat di beli saat ini.<p>Atau auth code anda salah.</div></center>";
        	//	}
}
  ...
  <footer role="contentinfo" class="probootstrap-footer">
    <div class="container">
      <div class="row mt40">
        ...
        <a href="https://play.google.com/store/apps/details?id=app.s.jagoanssh_com"><img src="/assets/img/playstore.png" height="100" weight="100"></a>
          <ul class="probootstrap-footer-social">
            <li><a href=""><i class="icon-twitter"></i></a></li>
            <li><a href=""><i class="icon-facebook"></i></a></li>
            <li><a href=""><i class="icon-instagram2"></i></a></li>
          </ul>
          <a href="/?do=terms-condition">Terms & Condition</a> | <a href="/?do=privacy-policy">Privacy Policy</a>
          <p>
