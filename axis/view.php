...
<section class="probootstrap-section">
    <div class="container">
    <div class="alert alert-danger text-center probootstrap-animate"><i class="icon-new"></i> S&K: SC level master masa aktif bisa di tumpuk</div>
    <div class="row">
    <div class="col-md-6 col-md-offset-3">
<form class="probootstrap-form probootstrap-box validate-form" method="post">
<center>
<h1>TEMBAK MASA AKTIF AXIS 720 HARI(MASTER)</h1></center>
...
<button class="btn btn-primary btn-block" type="submit" name="changestyle">Menu Tembak Kuota Anniversary</button>
<button class="btn btn-success btn-block" type="submit" name="submit-auth2">Beli Sekarang</button>
<br>
<?php
include('ads/ads.php');
?>
