  ...
  <section class="probootstrap-section">
    <div class="container">
      <div class="row">
        ...
        <h1>TUNEL SSH GRATIS <?php echo "$filter"; ?></h1>
        <h2>SERVIDORES TUNEL SSH GRATIS</h2>
...
?>
  ...
  <p class="text-center">
    <span class="badge badge-success mb-3 p-3">Cuentas SSH Gratis</span>
    <span class="badge badge-warning mb-3 p-3">VPS de Banda Ancha Ilimitada</span>
    <span class="badge badge-primary mb-3 p-3">SSH Veloces</span>
    <span class="badge badge-success mb-3 p-3">Cuentas Privadas</span>
    <span class="badge badge-info mb-3 p-3">Oculte su dirección IP</span>
    <span class="badge badge-primary mb-3 p-3">Cuentas SSH Veloces</span>
  </p> 
  <p class="text-center">
...
<!-- Server -->
      ...
      <p align="center"><a class="btn btn-danger" href="<?php urlPrefix('create-websocket-account/'.$row->id) ?>"><i class="fa fa-times" aria-hidden="true"></i> Create SSH</a></p>
      <?php else: ?>
      <p align="center"><a class="btn btn-primary" href="<?php urlPrefix('create-websocket-account/'.$row->id) ?>"><i class="fa fa-check" aria-hidden="true"></i> Create SSH</a></p>
      <?php endif; ?>
    </div>
    </div>
  <!-- End Server -->
