...
switch($_GET['filter']) {
  case 'one-month':
    ...
    $dimas = "`type`='vpnssh' $filter OR `type`='pptp' $filter";
  break;
  case 'extra':
    $dimas = "`type`='extra'";
  break;
...
?>
<div id="where" style="display:none;">pptp-sstp-server</div>
<div id="ndexi" style="display:none;">pptp-sstp-l2tp-server</div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 col-md-offset-2 section-heading mb50 text-center">
          <h1>FREE PPTP SSTP L2TP VPN SERVERS</h1>
          <h2>Free PPTP SSTP L2TP VPN Accounts</h2>
          <p class="lead">Select PPTP Server Location According to Your Needs</p>
          <p class="lead">PPTP SSTP L2TP We have different Speeds for each country</p>
...
<!-- Server -->
        <div class="container col-md-3 col-md-offset-1 probootstrap-section probootstrap-animate" data-animate-effect="fadeInRight">
          <div class="probootstrap-pricing popular">
            ...
            <ul>
              ...
              <li>SSTP Port: <?php echo $row->ssl_tls ?></li>
      ...
      <p align="center"><a class="btn btn-danger" href="<?php urlPrefix('create-pptp/'.$row->id) ?>"><i class="fa fa-times" aria-hidden="true"></i> Create VPN</a></p>
      <?php else: ?>
      <p align="center"><a class="btn btn-primary" href="<?php urlPrefix('create-pptp/'.$row->id) ?>"><i class="fa fa-check" aria-hidden="true"></i> Create VPN</a></p>
      <?php endif; ?>
    </div>
    </div>
  <!-- End Server -->
