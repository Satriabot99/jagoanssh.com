...
if($s):
  ...
  if($vpn):
    ...
    Pass : ".$password."<br/>
    Exp  : ".$exp."<br/>
    <div class='alert alert-danger text-center'><i class='icon-new'></i> Note : only ".$serverData->max_login." logins maximum<p>
    Multiple logins are automatically disconnect</div>";
  else:
    $successText ="
    Host : ".$serverData->host."<br/>
    User : ".$username."<br/>
