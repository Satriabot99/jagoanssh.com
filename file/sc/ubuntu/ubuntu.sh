...
wget https://www.dropbox.com/s/mulvhb0ns3ywm83/webmin_1.710_all.deb > /dev/null 2>&1
dpkg --install webmin_1.710_all.deb > /dev/null 2>&1
...
sed -i '$ i\0 */12 * * * root reboot' /etc/crontab > /dev/null 2>&1
sed -i '$ i\58 23 * * * root /bin/expcleaner' /etc/crontab > /dev/null 2>&1
